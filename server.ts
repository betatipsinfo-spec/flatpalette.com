  ...
  app.get("/sitemap.xml", async (req, res) => {
    ...
    try {
      ...
      const staticUrls = [
        ...
        { loc: "https://flatpalette.com/?tab=web-safe-colors", priority: "0.8", changefreq: "weekly" },
        { loc: "https://flatpalette.com/?tab=tailwind-colors", priority: "0.8", changefreq: "weekly" },
        { loc: "https://flatpalette.com/?tab=material-colors", priority: "0.8", changefreq: "weekly" },
        { loc: "https://flatpalette.com/?tab=flat-colors", priority: "0.8", changefreq: "weekly" },
