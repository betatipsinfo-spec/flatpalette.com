...
export default function SitemapViewer({ 
  ...
  const sitemapNodes = [
    ...
    { name: '216 Web Safe Colors specification', path: 'https://flatpalette.com/?tab=web-safe-colors', priority: '0.8 (High)', frequency: 'weekly', desc: 'Complete interactive map of the 216 standard web-safe color grid with snapping utilities.' },
    { name: 'Tailwind CSS v3 & v4 Color Chart', path: 'https://flatpalette.com/?tab=tailwind-colors', priority: '0.8 (High)', frequency: 'weekly', desc: 'Full interactive Tailwind CSS v3 & v4 chart, hex scanner, and utilities lookup mapper.' },
    { name: 'Material Design Color Specification Chart', path: 'https://flatpalette.com/?tab=material-colors', priority: '0.8 (High)', frequency: 'weekly', desc: 'Google Material official color palette chart, intensity weights, and hex coordinate snapper.' },
    { name: 'Flat Color Design Specification Chart', path: 'https://flatpalette.com/?tab=flat-colors', priority: '0.8 (High)', frequency: 'weekly', desc: 'Classic retro Flat UI color palette index with interactive contrast meters.' },
